    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f4f6f2' }}>
      <div style={{ background: 'white', padding: '3rem', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', color: '#172523' }}>DepoShop Kayıt</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', color: '#4a5568' }}>Şifre Tekrar</label>
            <input required type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #cbd5e0' }} />
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: '#718096', fontSize: '0.875rem' }}>
          Zaten hesabınız var mı? <Link to="/login" style={{ color: '#2d6a4f', fontWeight: 'bold', textDecoration: 'none' }}>Giriş Yap</Link>
        </p>
      </div>
    </div>
  );
